...
team_wts <- function(){
  data.frame(team=c(
    "CLE_east","CHI_east","BRK_east","PHI_east","MEM_west", # high
    "ATL_east","BOS_east","CHO_east","DET_east","IND_east","MIA_east","MIL_east",
    "NYK_east","ORL_east","TOR_east","WAS_east","DAL_west","DEN_west","HOU_west",
    "LAC_west","OKC_west","MIN_west","NOP_west","SAC_west","UTA_west",
    "LAL_west","GSW_west","SAS_west","PHO_west","POR_west" # low
