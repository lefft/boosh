# this is an example "trading system" from quantiacs, tutorial that 
# goes thru it bit by bit: 
#   https://www.youtube.com/watch?v=BNFA6NE7X1Q

# see also these vids: 
#   https://www.youtube.com/watch?v=aegqVgLJK24
#   https://www.youtube.com/watch?v=5w_i6mmAHQk

# and this repo: 
#   https://github.com/Quantiacs/quantiacs-python

# and this for window functions (in r but still useful):
