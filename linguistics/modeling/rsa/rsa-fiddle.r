...
eqnS4(utt, obj, objects, words) # problem w grepling!! *************
...
sp_assertion(utt, obj, objects)
# word        object         value 
# "circle" "blue_circle"        "TRUE" 

# GOTTA FIGGER AUT DIST FUNC!
...
prior_obj(obj, objects); prior_word(utt, words) 
prob_ref_given_word_in_context(obj, utt, objects, words) 
prob_word_given_ref_in_context(utt, obj, objects, words) 
...
# informativeness(utt, "", obj) # NO WORKIE! ******************
# un
